 ...
 class ExpNode 
{
  public:
	...
	*/
	...
	/*
		String evaluation, added in v 0.10
	*/
...
{
	private:
		ExpNode *_cond; //!< Expression of the repeat statement
		BlockStmt *_block; //!< Block of Statements of the body of the repeat loop1
	public:
		/*!
...
class IfStmt : public Statement 
{
 private:
  ...
  BlockStmt *_block1; //!< Statement of the consequent
  BlockStmt *_block2; //!< Statement of the alternative
...
*/
  IfStmt(ExpNode *condition, std::list<Statement*> *statement1)
	{
		this->_cond = condition;
		this->_block1 = new BlockStmt(statement1);
		this->_block2 = NULL;
	}
  ...
  IfStmt(ExpNode *condition, std::list<Statement*> *statement1, std::list<Statement*> *statement2)
	{
		this->_cond = condition;
		this->_block1 = new BlockStmt(statement1);
		this->_block2 = new BlockStmt(statement2);
	}
...
class ForStmt : public Statement
    ...
    private:
        ...
        ExpNode *_from;   //!< Since expresion of the for statement
        ExpNode *_to;   //!< Until expresion of the for statement
    ...
    public:
        /*!
            ...
            \param from //!< Expression that initializes the looping variable
            \param to //!< Condition to stop the loop
            \param block //!< List of Statements of the body of the loop
            \param step //!< Step of the loop
            \post  A new ForStmt is created with the parameters
        */
        ForStmt(std::string var, ExpNode *from, ExpNode *to, std::list<Statement *> *stmtList, ExpNode *step = NULL)
        {
            this->_var = var;
            this->_from = from;
            this->_to = to;
...
// New in v.0.11
    ...
    */
    ...
    {
    public:
        ExpNode *_exp; //!< Expression to evaluate in Value
        std::list<Statement *> *_stmtList; //!< std::list<Statement*> List of expresions with the statements of the value

    public:
        /*!
            \brief Constructor of ValueNode
            \param expCase: Pointer to the expression of the Value
            \param stmtList: Pointer to the list of statements of the Value
            \post  A new ValueNode is created with the parameter
        */
        ValueNode(ExpNode *expValue, std::list<Statement *> *stmtList) : _stmtList(stmtList)
        {
            this->_exp = expValue;
        }

        /*!
            \brief   Print the ValueNode
            \return  void
            \sa		 evaluate()
        */
        ...
        */
        ...
        /*!
            \brief   Returns the type of the ValueNode
        ...
        */
        ...
        /*!
            \brief   Get the expression of the ValueNode
            \return  ExpNode*
        */
        lp::ExpNode *getExp()
        {
...
// Modified in v.0.11
    ...
    /*!
      \class   BlockCaseValueNode
      \brief   Definition of atributes and methods of BlockCaseValeNode class
      \note    BlockSwitchCaseNode Class publicly inherits from Statement class
               and adds its own print and evaluate functions
    */
    class BlockCaseValueNode : public Statement
    {

    private:
        ExpNode *_exp;                 //!< Value of the case to "switch between values"
        std::list<ValueNode *> *_values; //!< List of CaseValues
        lp::ValueNode *_defaultValue;    //!< Default value

    public:
        /*!
            \brief Constructor of BlockSwitchCase
            \param initialValue: expresion with the name of the variable to be used in the value
            \param caseValuesList: list of values
            \param defaultValue: pointer to the default value
            \post  A new BlockSwitchCase is created with the parameters
        */
        BlockCaseValueNode(ExpNode *initialValue, std::list<lp::ValueNode *> *caseValuesList, lp::ValueNode *defaultValue = NULL) : _values(caseValuesList)
        {
        ...
        /*!
            \brief   Print the BlockCaseValue
            \return  void
            \sa		 evaluate()
        */
        void printAST();
        ...
        /*!
            \brief   Evaluate the BlockCaseValue
            \return  void
            \sa		 print()
        */
        void evaluate();
...
*/
	...
	{
	private:
		ExpNode *_exp; //Expresion to be evaluated
