...
@WebServlet(name="GetMultTempDeleteServlet", urlPatterns="/GetMultTempDeleteServlet")

public class GetMultTempDeleteServlet extends HttpServlet 
{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		EspectaculoDAO espDAO = new EspectaculoDAO(urlBD, userBD, passBD);
			...
			response.sendRedirect(request.getContextPath() + "/P3-Alt/views/EspMenu/deleteFechasAdmin.jsp"); 
