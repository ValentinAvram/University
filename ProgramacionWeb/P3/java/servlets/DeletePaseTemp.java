...
@WebServlet(name="DeletePaseTemp", urlPatterns="/DeletePaseTeemp")

public class DeletePaseTemp extends HttpServlet 
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		for(PasesDTO p: pasesUpdate)
		{
			if(idPases == p.getID())
			{
				...
				multDAO.deletePase(p);
			}
		}

		String ruta = request.getContextPath() + "/GetMultTempDeleteServlet"; //TODO: 
